...
void get_npe_woTRG2Cut_Point6(TString list)
{	
	...
	Int_t t1L=200, t1R=1100; //trig amps borders
	...
	//------Set selections-----------------------------
	CONDITION = "track.ys>"+by1+"   &&track.ys<"+by2+"  &&track.xs>"+bx1+"   &&track.xs<"+bx2+"  &&(chr4.ped-chr4.min)>"+bt1L+"&&(chr4.ped-chr4.min)<"+bt1R+"&&lecroy2249.ch0>"+bCEnL+"&&lecroy2249.ch0<"+bCEnR+" && track.trackis==1 && track.vz>=0.9998 && (chr6.max-chr6.ped)>15 && (chr7.ped-chr7.min)>8";
