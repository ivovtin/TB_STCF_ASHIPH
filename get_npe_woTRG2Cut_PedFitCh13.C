...
void get_npe_woTRG2Cut_PedFitCh13(TString list)
{	
	...
	Int_t t1L=150, t1R=700; //trig amps borders
	...
	TString CONDITIONwoCutsOnEn = "track.ys>"+by1+"   &&track.ys<"+by2+"  &&track.xs>"+bx1+"   &&track.xs<"+bx2+"  &&(chr4.ped-chr4.min)>"+bt1L+"&&(chr4.ped-chr4.min)<"+bt1R+" && track.trackis==1&&track.vz>=0.9998";
	//exbeamdata->Draw(DATA,CONDITIONwoCutsOnEn,"COLZ");
	exbeamdata->Draw(DATA,"","COLZ");

	DATA = "track.ys:track.xs>>hxyGEMswoXYcuts";
	TString CONDITIONWOGEMCUT = "(chr4.ped-chr4.min)>"+bt1L+"&&(chr4.ped-chr4.min)<"+bt1R+" &&lecroy2249.ch0>"+bCEnL+"&&lecroy2249.ch0<"+bCEnR+" && track.trackis==1 && track.vz>=0.9998";
	exbeamdata->Draw(DATA,CONDITIONWOGEMCUT,"colz");

	DATA = "track.ys:track.xs>>hxyGEMsXYWLS";
        TString CONDITIONGEMCUTWLS = "(chr4.ped-chr4.min)>"+bt1L+"&&(chr4.ped-chr4.min)<"+bt1R+"&& lecroy2249.ch0>"+bCEnL+"&&lecroy2249.ch0<"+bCEnR+" && track.trackis==1 && track.vz>=0.9998 && ch1.amp>1550";
        exbeamdata->Draw(DATA,CONDITIONGEMCUTWLS,"colz");

	//------Set selections-----------------------------
	CONDITION = "track.ys>"+by1+"   &&track.ys<"+by2+"  &&track.xs>"+bx1+"   &&track.xs<"+bx2+"  &&(chr4.ped-chr4.min)>"+bt1L+"&&(chr4.ped-chr4.min)<"+bt1R+"&&lecroy2249.ch0>"+bCEnL+"&&lecroy2249.ch0<"+bCEnR+" && track.trackis==1 && track.vz>=0.9998 && (chr6.max-chr6.ped)>18 && (chr7.ped-chr7.min)>11";
	...
	TString CONDITIONdtCntTrg1AmpCnt = "track.ys>"+by1+"   &&track.ys<"+by2+"  &&track.xs>"+bx1+"   &&track.xs<"+bx2+"  &&(chr4.ped-chr4.min)>"+bt1L+"&&(chr4.ped-chr4.min)<"+bt1R+"&& (ch1r.ped-ch1r.min)>0 &&lecroy2249.ch0>"+bCEnL+"&&lecroy2249.ch0<"+bCEnR+" &&track.trackis==1&&track.vz>=0.9998 && abs(Tmcp-Ttrig1)>0.0";
	...
	TString CONDITIONdtCntTrg2AmpCnt = "track.ys>"+by1+"   &&track.ys<"+by2+"  &&track.xs>"+bx1+"   &&track.xs<"+bx2+"  &&(chr4.ped-chr4.min)>"+bt1L+"&&(chr4.ped-chr4.min)<"+bt1R+"&& (ch1r.ped-ch1r.min)>0 &&lecroy2249.ch0>"+bCEnL+"&&lecroy2249.ch0<"+bCEnR+" &&track.trackis==1&&track.vz>=0.999 && abs(Tmcp-Ttrig2)>0.0";
	...
	for( int j=1; j<=nch; j++ )
		...
		if( j==1 )
		{
			hAmpPed[j]->Fit("fitG","LQ","",-10.,13.00);
		}
		else if( j==3 )
		{
			hAmpPed[j]->Fit("fitG","LQ","",-10.,8.00);
		}
		else
		{
