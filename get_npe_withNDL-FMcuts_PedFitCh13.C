...
void get_npe_withNDL-FMcuts_PedFitCh13(TString list)
{	
	...
	CONDITION = "track.ys>"+by1+"   &&track.ys<"+by2+"  &&track.xs>"+bx1+"   &&track.xs<"+bx2+"  &&(chr4.ped-chr4.min)>"+bt1L+"&&(chr4.ped-chr4.min)<"+bt1R+"&&(chr5.ped-chr5.min)>"+bt2L+"&&(chr5.ped-chr5.min)<"+bt2R+"&&lecroy2249.ch0>"+bCEnL+"&&lecroy2249.ch0<"+bCEnR+" && track.trackis==1 && track.vz>=0.9998 && (chr6.max-chr6.ped)>18 && (chr7.ped-chr7.min)>11";
